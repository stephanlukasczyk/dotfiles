...
you should place your code here."
  ...
  (with-eval-after-load 'org
    ...
    (defvar org-my-teaching-files "~/teaching/org")
    (defvar org-my-research-files "~/research/org")
    (add-to-list 'org-agenda-files org-my-general-files)
    (add-to-list 'org-agenda-files org-my-teaching-files)
    (add-to-list 'org-agenda-files org-my-research-files)
